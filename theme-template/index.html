...
<html>
    <head>
        ...
        <!-- Css frameworks and fontawesome -->
          ...
          <section id="home-clients" class="home-happyclients">
            ...
            <footer id="home-footer" class="py-5">
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12 d-none d-lg-block offset-1">
                  <form>
              ...
              <div class="d-flex justify-content-between py-4 my-4 border-top">
                ...
                <ul class="list-unstyled d-flex">
                  <li class="ms-3"><a class="link-dark" href="#"><i class="fab fa-facebook footericons"></i></a></li>
                  <li class="ms-3"><a class="link-dark" href="#"><i class="fab fa-instagram footericons"></i></a></li>
